...
2. 文件读取：因为是自动遍历某一文件夹下的所有文件，所以在定位文件的时候并不需要特别具体的文件位置。例如：我的文件存储在"前缀/QGIS/数据"中,但是我并不知道具体有什么文件,如下图所示![alt text](image/README/1732099737604.png)这时候只需要定位到"QGIS"即可:![alt text](image-1.png)![alt text](image.png)这样即可完成对文件夹的遍历。
